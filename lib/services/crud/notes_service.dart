...
//   Future<DatabaseNote> createNote({required DatabaseUser databaseUser}) async {
//     await _ensureDbIsOpen();
//     final db = _getDatabaseOrThrow();
//     final dbUser = await getUser(email: databaseUser.email);
//     if (dbUser != databaseUser) {
//       throw CouldNotFindUser();
//     }
//     const text = '';
//     final noteId = await db.insert(noteTable, {
//       userIdColumn: databaseUser.id,
//       textColumn: text,
